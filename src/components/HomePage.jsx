  ...
  const Bio = () => (
    <>
      ...
      <div className="f6 mt3 near-black">
        <p className="mb2"><a href="/about" className="blue underline hover-no-underline">learn more</a></p>
        <p className="mb0"><a href="mailto:hey@queral.studio" className="blue underline hover-no-underline">get in touch</a></p>
      </div>
    </>
  )

...
const notesMetadata = {
  ...
  'choose-your-own-adventure-slides': { title: 'Big Trouble, Little Tokyo', subtitle: 'thoughts on generating interactive fiction in powerpoint', date: 'March 2026', pageBgClass: 'bg-white' },

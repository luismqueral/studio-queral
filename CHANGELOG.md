...
- created `.cursor/rules/writing-voice.mdc` — a style guide that captures Luis's writing voice and catalogs specific LLM patterns to avoid, scoped to `src/notes/content/*.md`
- added screenshots from the Google Slides deck to the choose-your-own-adventure article — captured title, instructions, gameplay, and ending slides; placed the gameplay screenshot after the intro and the ending screenshot after the layout section

2026-03-04
- added new "Making a Choose-your-own-adventure Game in Google Slides" note with video asset
